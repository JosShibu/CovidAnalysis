-- This Analysis makes use of 2 Tables
-- The CovidDeaths table and the,
-- The CovidVaccinations table
...
-- Bringing covidVaccinations into consideration for vaccination vs. deaths insights
-- 
select d.location,
	d.date,
	d.population,
